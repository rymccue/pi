...
2. `reviewer`: Review the worker's changes/context. Use `{previous}` to pass worker output. Return critical issues, warnings, suggestions, and line-specific feedback where possible. Mark missing context [blocked].
